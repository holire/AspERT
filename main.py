...
from aspert import input_reader
from aspert.spert_trainer import ASpERTTrainer
...
def __train(run_args):
    trainer = ASpERTTrainer(run_args)
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        raise Exception("Mode not in ['train', 'eval', 'predict'], e.g. 'python aspert.py train ...'")
